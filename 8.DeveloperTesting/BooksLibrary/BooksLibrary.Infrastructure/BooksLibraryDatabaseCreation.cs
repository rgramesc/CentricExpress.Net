...
public class BooksLibraryDatabaseCreation
{
    ...
    public async Task InitiateDatabaseTablesWithData(string databaseName)
    {
...
";
    ...
    public async Task SeedDataInDatabase()
    {
        ...
        var cloudDataPatternsBook = Book.CreateBook(new List<Author> { new("Rob", "Vettor") }, new DateOnly(2024, 1, 2),
